...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    category: 'Getting Started',
    body: [
      'Set an activity status to let friends and server members know what you\'re doing — for example, "Playing Minecraft" or "Listening to Spotify."',
  ...
  },
  {
    ...
    body: [
      ...
      'Check the member list (right sidebar in any channel) to see who\'s online in a server.',
  ...
  },
  {
    ...
    body: [
      ...
      'Your status is only visible to members of servers you belong to and your friends list. Strangers cannot see your presence.',
