...
const EmojiPicker = ({ onSelectEmoji, onSendGif, onStickerSelect, guildId }: {
    ...
    return (
        <div className="emoji-picker" style={{ position: 'absolute', bottom: 'calc(100% + 12px)', right: '0', width: 'min(400px, calc(100vw - 16px))', height: '460px', background: 'var(--bg-elevated)', border: '1px solid var(--stroke)', borderRadius: '12px', boxShadow: '0 10px 40px rgba(0,0,0,0.6)', display: 'flex', flexDirection: 'column', overflow: 'hidden', zIndex: 100, animation: 'scaleIn 0.2s ease-out' }}>
