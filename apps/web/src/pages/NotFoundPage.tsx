...
export function NotFoundPage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', background: '#2c2c3e', color: '#e8e4e0', gap: 16 }}>
      ...
      <button onClick={() => navigate('/')} style={{ marginTop: 8, padding: '10px 24px', background: '#d4af37', color: '#1a1a2e', border: 'none', borderRadius: 8, fontWeight: 700, fontSize: 14, cursor: 'pointer' }}>Go Home</button>
    </div>
  );
}
