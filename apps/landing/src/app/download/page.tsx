...
const platforms = [
  {
    ...
    href: "https://gratonite.chat/downloads/Gratonite-1.0.0-arm64.dmg",
  },
  {
    icon: "⊞",
    name: "Windows (x64)",
    ...
    href: "https://gratonite.chat/downloads/Gratonite%20Setup%201.0.0.exe",
  },
  {
    icon: "🐧",
    name: "Linux",
