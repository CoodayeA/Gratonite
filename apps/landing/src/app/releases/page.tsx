...
const releases = [
  ...
  },
  {
    ...
    changes: [
      ...
      "Raid protection toggle for servers",
  ...
  },
  {
    ...
    changes: [
      ...
      "Slash commands and server boosts",
    ],
  },
  {
    version: "1.0.1",
...
const roadmap = [
  ...
  },
  {
    ...
    status: "done" as const,
    description: "User-created themes with full CSS customization per server.",
  },
  {
    feature: "Federated servers",
    status: "done" as const,
