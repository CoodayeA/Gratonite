...
description: "Discord privacy concerns, Nitro paywalls, and phone-number gates pushed us to build something better. Here is why Gratonite exists."
date: "2026-03-06"
...
If we're asking people to trust us with their conversations, they should be able to verify that trust. Open source means anyone can read the code, audit the claims, and hold us accountable.
