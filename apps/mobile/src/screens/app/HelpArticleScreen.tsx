...
const ARTICLES_FULL: Record<string, { title: string; body: string[] }> = {
  'getting-started': { title: 'Getting Started with Gratonite', body: ['Download and install Gratonite from the official website or use the web app.', 'Create your account by providing a username, email, and password.', 'Explore the sidebar to find your portals, direct messages, and notifications.', 'Join an existing portal using an invite link, or create your own.', 'Customize your experience in Settings.'] },
  'creating-server': { title: 'Creating Your First Portal', body: ['Click the "+" button at the bottom of the portal sidebar.', 'Choose a template or start from scratch.', 'Name your portal and optionally add an icon.', 'Create channels for different topics or activities.', 'Invite friends using the invite link.'] },
  ...
  'roles-permissions': { title: 'Roles & Permissions', body: ['Roles define what members can do in your portal.', 'Create roles in Portal Settings > Roles.', 'Assign permissions like Manage Channels, Kick Members, etc.', 'Use channel-specific permission overrides for fine-grained control.'] },
