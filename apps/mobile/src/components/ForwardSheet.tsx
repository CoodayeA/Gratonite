...
import { guilds as guildsApi, channels as channelsApi, messages as messagesApi } from '../lib/api';
...
export default function ForwardSheet({ visible, onClose, content }: ForwardSheetProps) {
  ...
  const handleChannelSelect = async (channel: Channel) => {
    ...
    setSending(true);
    try {
      await messagesApi.send(channel.id, content);
